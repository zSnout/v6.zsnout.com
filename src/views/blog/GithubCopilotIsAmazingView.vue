<script setup>
  import copilotAccountURL from "@/assets/copilot-account.png";
  import copilotSchemaURL from "@/assets/copilot-schema.png";
  import BlogArticle from "@/components/BlogArticle.vue";
  import { dedent } from "@/components/Markdown.vue";

  let source = dedent`
  _Published by [Zachary Sakowitz](https://github.com/zsakowitz) on December 9, 2021._
  ...
  ![An example of Copilot in action](${copilotAccountURL})
  ...
  ![Another example of Copilot](${copilotSchemaURL})
