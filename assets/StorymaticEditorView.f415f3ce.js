...
`),x=w('"Press Ctrl-Enter or Cmd-Enter while in the editor to run your program."'),y=setInterval(()=>{J.replace(`/storymatic/${d(r.value)}`)},5e3);return q(()=>clearInterval(y)),(u,a)=>{const n=Z("GlobalEvents");return p(),g(k,null,[$(n,{onKeydown:[N(j(_,["ctrl"]),["enter"]),N(j(_,["meta"]),["enter"])]},null,8,["onKeydown"]),$(Q,{"explicit-height":""},{nav:V(()=>[$(Y,{onClick:_},{default:V(()=>[me]),_:1})]),default:V(()=>[M("div",pe,[$(ne,{modelValue:h(r),"onUpdate:modelValue":a[0]||(a[0]=l=>R(r)?r.value=l:r=l),class:"editor",onInit:s},null,8,["modelValue"]),$(ue,{class:"viewer",code:h(x),autofocus:""},null,8,["code"])])]),_:1})],64)}}});var ge=B(fe,[["__scopeId","data-v-d9bc0e9a"]]);export{ge as default};
