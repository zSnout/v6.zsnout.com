import{_ as I,d as V,K as F,e as b,L as R,l as D,o as m,f as g,F as k,g as P,n as S,t as N,z as W,u as h,a as C,I as O,J as K,i as B,G as H,H as U,M as z,c as G,s as L,v as J,x as q,r as Y,j as $,O as T,P as j,D as Q,w as A,N as X,b as Z}from"./index.b5946be6.js";import{s as ee,_ as ne}from"./storymatic.5c5f453f.js";const te=f=>(H("data-v-6f87b757"),f=f(),U(),f),oe={key:0,class:"message select"},se=["disabled","onClick"],ie=te(()=>C("span",{class:"option-cap"},null,-1)),re=["placeholder"],ae=V({props:{messages:{default:()=>F([])},placeholder:null,root:{type:Boolean}},emits:["enter","field","select"],setup(f,{emit:d}){const{messages:u,root:p}=f;let s=b("");function _(n){n.preventDefault(),s.value.trim()?(u.push({content:s.value.trim(),type:"user"}),d("field",s.value.trim()),s.value=""):d("enter")}let r=b(null);function x(){let n=p?document.documentElement:r.value;return n?n.scrollHeight-n.scrollTop-n.clientHeight<4:!1}function y(){let n=p?document.documentElement:r.value;!n||(n.scrollTop=n.scrollHeight)}function c(n,l){n.selected=l,d("select",n.name,l)}let a=b(null);return R(u,()=>{let n=u[u.length-1];if(n&&n.type=="focus"&&!n.hidden)return setTimeout(()=>{var l;if(n.type=="focus"&&(n.where=="field"&&((l=a.value)==null||l.focus()),n.where=="select")){if(!r.value)return;let i=r.value.getElementsByClassName("select"),v=i[i.length-1].children[0];v==null||v.focus()}});x()&&setTimeout(y)}),D(y),(n,l)=>(m(),g("div",{ref_key:"consoleEl",ref:r,class:S([{root:h(p)},"console"])},[(m(!0),g(k,null,P(h(u),(i,v)=>(m(),g(k,{key:v},[i.type!="focus"&&!i.hidden?(m(),g(k,{key:0},[i.type=="select"?(m(),g("div",oe,[(m(!0),g(k,null,P(i.options,(M,e)=>(m(),g("button",{key:e,class:S([{selected:i.selected==e},"option"]),disabled:!!i.selected,onClick:t=>c(i,""+e)},N(M),11,se))),128)),ie])):(m(),g("div",{key:1,class:S([i.type,"message"])},N(i.content),3))],64)):W("",!0)],64))),128)),C("form",{class:"form",onSubmit:_},[O(C("input",{ref_key:"fieldEl",ref:a,"onUpdate:modelValue":l[0]||(l[0]=i=>B(s)?s.value=i:s=i),class:"field",placeholder:f.placeholder},null,8,re),[[K,h(s)]])],32)],2))}});var le=I(ae,[["__scopeId","data-v-6f87b757"]]),ue=`let post = self.postMessage;
...
export {};
`;const ce=V({props:{code:null,autofocus:{type:Boolean}},setup(f){const d=f;let u=b("Send messages to program..."),{autofocus:p}=d,s;function _(e){s&&s(e)}let r;function x(){r&&r()}let y;function c(e,t){y&&y(e,t)}let a=F([]),n=M(d.code,!1);R(z(d,"code"),e=>n=M(e,!0));function l(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"||typeof e=="bigint"}function i(e){return e==null?"":l(e)?""+e:typeof e=="function"?`function ${e.name}()`:Array.isArray(e)?e.map(i).filter(t=>t).join(`
...
${p.getValue()}`}let r=b(u(""+(L().params.code||""))||`# After working on a project, bookmark your page to save your code.
...
`),x=b('"Press Ctrl-Enter or Cmd-Enter while in the editor to run your program."'),y=setInterval(()=>{J.replace(`/storymatic/${d(r.value)}`)},5e3);return q(()=>clearInterval(y)),(c,a)=>{const n=Y("GlobalEvents");return m(),g(k,null,[$(n,{onKeydown:[T(j(_,["ctrl"]),["enter"]),T(j(_,["meta"]),["enter"])]},null,8,["onKeydown"]),$(Q,{"explicit-height":""},{nav:A(()=>[$(X,{onClick:_},{default:A(()=>[pe]),_:1})]),default:A(()=>[C("div",me,[$(ne,{modelValue:h(r),"onUpdate:modelValue":a[0]||(a[0]=l=>B(r)?r.value=l:r=l),class:"editor",onInit:s},null,8,["modelValue"]),$(ce,{class:"viewer",code:h(x),autofocus:""},null,8,["code"])])]),_:1})],64)}}});var ge=I(fe,[["__scopeId","data-v-d9bc0e9a"]]);export{ge as default};
