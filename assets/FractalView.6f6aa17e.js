import{g as se,s as re}from"./cookie.648245ab.js";import{a as le}from"./modal.75408464.js";import{d as oe,o as j,c as Z,w as R,u as G,N as W,z as ne,h as ce,b as X,s as fe,e as H,l as ue,x as pe,v as P,j as Q}from"./index.b5946be6.js";import{W as de}from"./WebGL2Canvas.1198b5f2.js";import"./FullscreenCanvas.0af4e350.js";import"./FullscreenDisplay.f28d5208.js";let he={"+":2,"-":2,"*":3,"/":3,"**":4,"^":5};function J(a){return a=="("?0:he[a]||1}let ze={"+":"l","-":"l","*":"l","/":"l"};function me(a){return ze[a]||"r"}let ve=["+","-","*","/","^","("];function K(a){return!ve.includes(a)}function ee(a){let i=[],e=!1;for(;;){let t;if(a.length===0)break;(t=a.match(/^\d+(?:\.\d+)?/))?(e&&i.push("**"),e=!0,i.push(+t[0]),a=a.slice(t[0].length)):(t=a.match(/^(sin|cos|tan|exp|log|abs|min|max|rawsqr)/))?(e&&i.push("**"),e=!1,i.push(t[0]),a=a.slice(t[0].length)):(t=a.match(/^(pi|pz|ppz|sz|e|i|c|z)/))?(e&&i.push("**"),e=!0,i.push(t[0]),a=a.slice(t[0].length)):((t=a.match(/^[-+*\/^()]/))&&(e&&t[0]=="("&&i.push("**"),e=!1,t[0]==")"&&(e=!0),i.push(t[0])),a=a.slice(1))}let d=[],r=[],c;for(;c=i.shift();)if(typeof c=="number"||c.match(/^(pi|pz|ppz|sz|e|i|c|z)$/))d.push(c);else if(c==")"){for(;r[r.length-1]!="(";){let f=r[r.length-1];if(!f)return["z"];r.pop(),d.push(f)}if(r.pop()!="(")return["z"];let t=r[r.length-1];if(!t)continue;K(t)&&(r.pop(),d.push(t))}else if(c=="("||K(c))r.push(c);else{let t=c,f;for(;(f=r[r.length-1])&&f!="(";){let y=J(t),h=J(f);if(!(h>y||y==h&&me(t)=="l"))break;d.push((r.pop(),f))}r.push(t)}for(;c=r.pop();){if(c=="("||c==")")return["z"];d.push(c)}return d}function te(a){try{let i=[];for(let e of a)if(typeof e=="number")i.push(`vec2(${e}, 0)`);else if(e=="i")i.push("vec2(0, 1)");else if(e=="pi")i.push("vec2(3.141592653589793, 0)");else if(e=="e")i.push("vec2(2.718281828459045, 0)");else if(e.match(/^(pz|ppz|sz|c|z)$/))i.push(e);else if(e=="+"||e=="-"){let d=i.pop(),r=i.pop();i.push(`${r} ${e} ${d}`)}else if(e=="*"||e=="**"||e=="/"||e=="^"||e=="min"||e=="max"){e=="/"?e="div":e=="^"?e="power":(e=="*"||e=="**")&&(e="mult");let d=i.pop(),r=i.pop();i.push(`${e}(${r}, ${d})`)}else(e=="sin"||e=="cos"||e=="tan"||e=="exp"||e=="log"||e=="abs"||e=="rawsqr")&&i.push(`${e}(${i.pop()})`);return i.length!=1?"z":i[0]}catch{return"z"}}const xe=X("Reset"),ye=oe({props:{shader:null,showResetButton:{type:Boolean},breakpoint:null},emits:["ready"],setup(a,{emit:i}){const e=a;let{showResetButton:d,breakpoint:r}=e,c=`
    ...
    `}let T=H(O());return ue(()=>{se("hasVisitedFractalView")!="1"&&le("When using a touchscreen, drag your finger to move the image and use two finger pinching to zoom in and out. When using a desktop, click and drag to move the image and scroll on the image to zoom in and out. You may also pinch to zoom on a trackpad.").then(()=>re("hasVisitedFractalView","1"))}),pe(()=>clearInterval(q)),($,z)=>(j(),Z(ye,{breakpoint:650,shader:G(T),"show-reset-button":"",onReady:N},{nav:R(()=>[Q(W,{title:"Lowers the amount of detail in the fractal but improves performance.",onClick:A},{default:R(()=>[Ne]),_:1}),Q(W,{title:"Increases the amount of detail in the fractal but degrades performance.",onClick:w},{default:R(()=>[be]),_:1}),Q(W,{title:"Changes the equation used to draw the fractal.",onClick:g},{default:R(()=>[ge]),_:1}),Q(W,{title:"Changes the theme between standard mode, four rainbow mode, two exterior hue modes, and two interior hue modes.",onClick:b},{default:R(()=>[we]),_:1})]),_:1},8,["shader"]))}});export{Le as default};
