import{g as re,s as se}from"./cookie.648245ab.js";import{a as le}from"./modal.7a154f05.js";import{N as q,r as P}from"./index.dadf590a.js";import{W as ne}from"./WebGL2Canvas.1d83f6e1.js";import{d as oe,o as j,c as K,w as R,u as G,L as ce,r as fe,e as W,K as ue,f as Z,q as pe,s as de,j as Q}from"./vendor.c311a53b.js";import"./FullscreenCanvas.331b4e0a.js";import"./FullscreenDisplay.f0508e4f.js";let he={"+":2,"-":2,"*":3,"/":3,"**":4,"^":5};function H(a){return a=="("?0:he[a]||1}let ze={"+":"l","-":"l","*":"l","/":"l"};function me(a){return ze[a]||"r"}let ve=["+","-","*","/","^","("];function J(a){return!ve.includes(a)}function ee(a){let i=[],e=!1;for(;;){let t;if(a.length===0)break;(t=a.match(/^\d+(?:\.\d+)?/))?(e&&i.push("**"),e=!0,i.push(+t[0]),a=a.slice(t[0].length)):(t=a.match(/^(sin|cos|tan|exp|log|abs|min|max|rawsqr)/))?(e&&i.push("**"),e=!1,i.push(t[0]),a=a.slice(t[0].length)):(t=a.match(/^(pi|pz|ppz|sz|e|i|c|z)/))?(e&&i.push("**"),e=!0,i.push(t[0]),a=a.slice(t[0].length)):((t=a.match(/^[-+*\/^()]/))&&(e&&t[0]=="("&&i.push("**"),e=!1,t[0]==")"&&(e=!0),i.push(t[0])),a=a.slice(1))}let d=[],s=[],c;for(;c=i.shift();)if(typeof c=="number"||c.match(/^(pi|pz|ppz|sz|e|i|c|z)$/))d.push(c);else if(c==")"){for(;s[s.length-1]!="(";){let f=s[s.length-1];if(!f)return["z"];s.pop(),d.push(f)}if(s.pop()!="(")return["z"];let t=s[s.length-1];if(!t)continue;J(t)&&(s.pop(),d.push(t))}else if(c=="("||J(c))s.push(c);else{let t=c,f;for(;(f=s[s.length-1])&&f!="(";){let y=H(t),h=H(f);if(!(h>y||y==h&&me(t)=="l"))break;d.push((s.pop(),f))}s.push(t)}for(;c=s.pop();){if(c=="("||c==")")return["z"];d.push(c)}return d}function te(a){try{let i=[];for(let e of a)if(typeof e=="number")i.push(`vec2(${e}, 0)`);else if(e=="i")i.push("vec2(0, 1)");else if(e=="pi")i.push("vec2(3.141592653589793, 0)");else if(e=="e")i.push("vec2(2.718281828459045, 0)");else if(e.match(/^(pz|ppz|sz|c|z)$/))i.push(e);else if(e=="+"||e=="-"){let d=i.pop(),s=i.pop();i.push(`${s} ${e} ${d}`)}else if(e=="*"||e=="**"||e=="/"||e=="^"||e=="min"||e=="max"){e=="/"?e="div":e=="^"?e="power":(e=="*"||e=="**")&&(e="mult");let d=i.pop(),s=i.pop();i.push(`${e}(${s}, ${d})`)}else(e=="sin"||e=="cos"||e=="tan"||e=="exp"||e=="log"||e=="abs"||e=="rawsqr")&&i.push(`${e}(${i.pop()})`);return i.length!=1?"z":i[0]}catch{return"z"}}const xe=W("Reset"),ye=oe({props:{shader:null,showResetButton:{type:Boolean},breakpoint:null},emits:["ready"],setup(a,{emit:i}){const e=a;let{showResetButton:d,breakpoint:s}=e,c=`
    #version 300 es
