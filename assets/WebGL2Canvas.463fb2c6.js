import{_ as h}from"./FullscreenCanvas.93cbe552.js";import{_ as A}from"./index.b946931f.js";import{d as v,o as S,c as b,w as g,r as P}from"./vendor.5ba71872.js";function d(e,o,n){let t=e.createShader(e[`${o}_SHADER`]);return t?(e.shaderSource(t,n.trim()),e.compileShader(t),e.getShaderParameter(t,e.COMPILE_STATUS)?t:(console.log(e.getShaderInfoLog(t)),e.deleteShader(t),null)):null}function R(e,o,n){let t=e.createProgram();if(!t)return null;let s=d(e,"VERTEX",o);if(!s)return null;let a=d(e,"FRAGMENT",n);return a?(e.attachShader(t,s),e.attachShader(t,a),e.linkProgram(t),e.getProgramParameter(t,e.LINK_STATUS)?t:(console.log(e.getProgramInfoLog(t)),e.deleteProgram(t),null)):null}const L=v({props:{shader:null,breakpoint:null},emits:["ready"],setup(e,{emit:o}){const{shader:n}=e;let t=`
  #version 300 es
