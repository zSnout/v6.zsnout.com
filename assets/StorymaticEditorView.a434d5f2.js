...
export {};
`;const ue=A({__name:"StorymaticViewer",props:{code:null,autofocus:{type:Boolean}},setup(f){const d=f;let c=w("Send messages to program..."),{autofocus:m}=d,s;function _(e){s&&s(e)}let r;function x(){r&&r()}let y;function u(e,t){y&&y(e,t)}let a=I([]),n=E(d.code,!1);F(G(d,"code"),e=>n=E(e,!0));function l(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"||typeof e=="bigint"}function i(e){return e==null?"":l(e)?""+e:typeof e=="function"?`function ${e.name}()`:Array.isArray(e)?e.map(i).filter(t=>t).join(`
...
`),x=w('"Press Ctrl-Enter or Cmd-Enter while in the editor to run your program."'),y=setInterval(()=>{J.replace(`/storymatic/${d(r.value)}`)},5e3);return q(()=>clearInterval(y)),(u,a)=>{const n=Z("GlobalEvents");return p(),g(k,null,[$(n,{onKeydown:[N(j(_,["ctrl"]),["enter"]),N(j(_,["meta"]),["enter"])]},null,8,["onKeydown"]),$(X,{"explicit-height":""},{nav:V(()=>[$(Y,{onClick:_},{default:V(()=>[Q("Run Program")]),_:1})]),default:V(()=>[M("div",me,[$(ne,{modelValue:h(r),"onUpdate:modelValue":a[0]||(a[0]=l=>R(r)?r.value=l:r=l),class:"editor",onInit:s},null,8,["modelValue"]),$(ue,{class:"viewer",code:h(x),autofocus:""},null,8,["code"])])]),_:1})],64)}}});var ye=B(pe,[["__scopeId","data-v-d9bc0e9a"]]);export{ye as default};
