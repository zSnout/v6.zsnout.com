import{N as s,r as x}from"./index.84f7671e.js";import{W as m}from"./WebGL2Canvas.fea335a1.js";import{d as p,K as _,o as b,c as y,w as r,j as c,e as i}from"./vendor.c311a53b.js";import"./FullscreenCanvas.19b485a7.js";import"./FullscreenDisplay.6bfb8df4.js";const k=i("More Rainbow"),z=i("More Random"),L=p({setup(F){let e=+_().params.chance;(e<0||e>100)&&(e=50),e=Math.floor(e);let n;function u({gl:o,program:t,render:d}){let v=o.getUniformLocation(t,"seed"),l=o.getUniformLocation(t,"chance");n=()=>{o.uniform1f(v,Math.random()),o.uniform1f(l,e/100),d()},n()}function a(){n==null||n()}function h(){e<=0||(e<=10||e>90?e-=1:e-=5,x.replace(`/rainbow-noise/${e}`),a())}function f(){e>=100||(e<10||e>=90?e+=1:e+=5,x.replace(`/rainbow-noise/${e}`),a())}return(o,t)=>(b(),y(m,{shader:`
  ...
  `,onReady:u,onResize:a},{nav:r(()=>[c(s,{onClick:h},{default:r(()=>[k]),_:1}),c(s,{onClick:f},{default:r(()=>[z]),_:1})]),_:1},8,["shader"]))}});export{L as default};
