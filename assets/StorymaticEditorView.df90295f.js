...
export {};
`;const ce=V({props:{code:null,autofocus:{type:Boolean}},setup(f){const d=f;let u=b("Send messages to program..."),{autofocus:p}=d,s;function _(e){s&&s(e)}let r;function x(){r&&r()}let y;function c(e,t){y&&y(e,t)}let a=F([]),n=E(d.code,!1);R(G(d,"code"),e=>n=E(e,!0));function l(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"||typeof e=="bigint"}function i(e){return e==null?"":l(e)?""+e:typeof e=="function"?`function ${e.name}()`:Array.isArray(e)?e.map(i).filter(t=>t).join(`
