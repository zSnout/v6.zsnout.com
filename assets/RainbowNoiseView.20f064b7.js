import{d as m,s as p,o as b,c as _,w as r,j as s,N as x,b as i,v as c}from"./index.a3a94a1d.js";import{W as y}from"./WebGL2Canvas.5aabbf7c.js";import"./FullscreenCanvas.f3e7346c.js";import"./FullscreenDisplay.b16948a2.js";const k=i("More Rainbow"),z=i("More Random"),I=m({setup(F){let e=+p().params.chance;(e<0||e>100)&&(e=50),e=Math.floor(e);let n;function u({gl:o,program:t,render:d}){let v=o.getUniformLocation(t,"seed"),l=o.getUniformLocation(t,"chance");n=()=>{o.uniform1f(v,Math.random()),o.uniform1f(l,e/100),d()},n()}function a(){n==null||n()}function h(){e<=0||(e<=10||e>90?e-=1:e-=5,c.replace(`/rainbow-noise/${e}`),a())}function f(){e>=100||(e<10||e>=90?e+=1:e+=5,c.replace(`/rainbow-noise/${e}`),a())}return(o,t)=>(b(),_(y,{shader:`
  #version 300 es
  ...
  `,onReady:u,onResize:a},{nav:r(()=>[s(x,{onClick:h},{default:r(()=>[k]),_:1}),s(x,{onClick:f},{default:r(()=>[z]),_:1})]),_:1},8,["shader"]))}});export{I as default};
