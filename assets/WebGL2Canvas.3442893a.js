import{_ as v}from"./FullscreenCanvas.3a795021.js";import{_ as b,d as A,o as S,e as g,w as P,g as R}from"./index.050728da.js";function d(e,o,n){let t=e.createShader(e[`${o}_SHADER`]);return t?(e.shaderSource(t,n.trim()),e.compileShader(t),e.getShaderParameter(t,e.COMPILE_STATUS)?t:(console.log(e.getShaderInfoLog(t)),e.deleteShader(t),null)):null}function L(e,o,n){let t=e.createProgram();if(!t)return null;let s=d(e,"VERTEX",o);if(!s)return null;let u=d(e,"FRAGMENT",n);return u?(e.attachShader(t,s),e.attachShader(t,u),e.linkProgram(t),e.getProgramParameter(t,e.LINK_STATUS)?t:(console.log(e.getProgramInfoLog(t)),e.deleteProgram(t),null)):null}const B=A({__name:"WebGL2Canvas",props:{shader:null,breakpoint:null,preserveDrawingBuffer:{type:Boolean}},emits:["ready"],setup(e,{emit:o}){const{shader:n,preserveDrawingBuffer:t}=e;let s=`
  #version 300 es
