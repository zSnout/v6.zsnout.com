import{_ as v}from"./FullscreenCanvas.49c980d2.js";import{_ as A,d as S,o as b,c as g,w as P,h as R}from"./index.a7d7fbf6.js";function d(e,o,n){let t=e.createShader(e[`${o}_SHADER`]);return t?(e.shaderSource(t,n.trim()),e.compileShader(t),e.getShaderParameter(t,e.COMPILE_STATUS)?t:(console.log(e.getShaderInfoLog(t)),e.deleteShader(t),null)):null}function L(e,o,n){let t=e.createProgram();if(!t)return null;let s=d(e,"VERTEX",o);if(!s)return null;let l=d(e,"FRAGMENT",n);return l?(e.attachShader(t,s),e.attachShader(t,l),e.linkProgram(t),e.getProgramParameter(t,e.LINK_STATUS)?t:(console.log(e.getProgramInfoLog(t)),e.deleteProgram(t),null)):null}const B=S({props:{shader:null,breakpoint:null,preserveDrawingBuffer:{type:Boolean}},emits:["ready"],setup(e,{emit:o}){const{shader:n,preserveDrawingBuffer:t}=e;let s=`
  #version 300 es
